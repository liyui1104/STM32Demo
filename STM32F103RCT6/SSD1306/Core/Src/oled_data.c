...
/**
 * @brief  Data storage format in the OLED display memory array
 * 
 * @note   Vertically 8 dots, with the high-order bits at the bottom.
 *         First from left to right, then from top to bottom.
 *         Each bit corresponds to a pixel point.
 * 
 *            B0 B0                  B0 B0
 *            B1 B1                  B1 B1
 *            B2 B2                  B2 B2
...
/**
 * @brief  Coordinate axis definition in the OLED screen
 * 
 * @note   The top-left corner is the point (0,0).
 *         Horizontally to the right is the X-axis, with a value range of [0,127].
 *         Vertically downward is the Y-axis, with a value range of [0,63].
 * 
 *           0             X             127 
 *          .------------------------------->
 *        0 |
...
/* ASCII Font Library Definitions --------------------------------------------*/
...
/* OLED font library, 6 pixels wide, 8 pixels high */
...
/* Chinese Font Library Definitions ------------------------------------------*/

/**
 * @note  Each Chinese character only needs to be defined once.
 *        The order of Chinese characters does not matter.
 *        All characters must be Chinese characters or full-width characters.
 *        Do not include any half-width characters.
 */

/* OLED font library, 16 pixels wide, 16 pixels high */
const ChineseCell_t OLED_CF16x16[] = {
	...
	/* Following the format above, add the new Chinese at here */
	// ...
	
	
	// The default figure (a box with a question mark inside)
  // When the specified character is not found, make sure it is at the end of the array
	"",		
...
/* Image Library Definitions -------------------------------------------------*/

/* Test image (a box with diode symbols inside), 16 pixels wide, 16 pixels high */
const uint8_t Diode[] = {
...
/* Following the format above, add the new image at here */
// ...
